...
__DEFINE__(1642214890679, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642214890680,"./event-store":1642214890681}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642214890680, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642214890681, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642214890680,"./utils":1642214890682}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642214890682, function(require, module, exports) {
...
return __REQUIRE__(1642214890679);
})()
